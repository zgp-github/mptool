...
class Main_Page(QTabWidget):
    ...
    def station_config(self):
        ...
        if os.path.exists(config):
            ...
            conf.set("Station", "#station2", "ASSEMBLY_PAIR")
            conf.set("Station", "#station3", "ASSEMBLY_FTS")
            conf.set("Station", "#station4", "ASSEMBLY_ML1")
            conf.set("Station", "#station5", "ASSEMBLY_GCL")
            conf.set("Station", "#station6", "ASSEMBLY_REPAIR")
        ...
        conf.read(config)
        station = conf.get('Station', 'STATION')
